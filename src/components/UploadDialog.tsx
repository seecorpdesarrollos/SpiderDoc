...
export function UploadDialog({
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-end justify-center overlay-scrim backdrop-blur-sm sm:items-center sm:p-6">
        ...
        <div className="p-4">
          ...
          {(step === "review" || step === "saving") && (
            <div className="space-y-4">
              ...
              <label className="block">
                <span className="heading-meta text-brand-600">
                  Fecha de caducidad
                </span>
                <input
                  type="date"
